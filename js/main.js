...
$('#screenshot-carusel').owlCarousel({
  ...
  .type(null,{delay:100})
  .type("<p>Somos la solucion para hacer realidad tu sueño, solo si quieres tener precencia en internet tener tu propia tienda, o una revista digital trabajemos juntos</p>",{speed: 500})
  .go();
